...
//        }
    ...
    public static String getJarPath() {
        // StringUtils是jar文件内容
        URL url = null;//VirtualMachine.class.getProtectionDomain().getCodeSource().getLocation();
        ...
        if (success) {
            ...
            try{
            	...
            	try{
        			...
        			Instrumentation instrumentation = null;//JavaDynAgent.getInstrumentation();
    ...
    private boolean isNotBlank(String error) {
